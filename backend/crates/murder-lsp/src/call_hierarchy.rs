...
pub struct CallHierarchyItemInfo {
    ...
    pub selection_range: murder_text::Range,
...
pub struct IncomingCall {
    ...
    pub from_ranges: Vec<murder_text::Range>,
}
...
mod tests {
    ...
    fn call_hierarchy_item_info_serde() {
        let info = CallHierarchyItemInfo {
            ...
            range: murder_text::Range::new(
                ...
                murder_text::Position::new(5, 1),
            ),
            selection_range: murder_text::Range::new(
                murder_text::Position::new(0, 3),
                murder_text::Position::new(0, 7),
            ),
    ...
    fn call_hierarchy_item_symbol_kind() {
        let info = CallHierarchyItemInfo {
            ...
            uri: "file:///t.rs".into(),
            range: murder_text::Range::new(murder_text::Position::ZERO, murder_text::Position::ZERO),
            selection_range: murder_text::Range::new(
    ...
    fn incoming_call_serde() {
        let call = IncomingCall {
            from: CallHierarchyItemInfo {
                ...
                uri: "file:///a.rs".into(),
                range: murder_text::Range::new(
                    murder_text::Position::new(10, 0),
                    murder_text::Position::new(20, 1),
                ),
                selection_range: murder_text::Range::new(
                    murder_text::Position::new(10, 3),
                    murder_text::Position::new(10, 9),
                ),
                detail: None,
                raw: None,
            },
            from_ranges: vec![murder_text::Range::new(
                murder_text::Position::new(15, 4),
                murder_text::Position::new(15, 10),
            )],
        };
    ...
    fn outgoing_call_serde() {
        let call = OutgoingCall {
            to: CallHierarchyItemInfo {
                ...
                range: murder_text::Range::new(
                    murder_text::Position::new(0, 0),
                    murder_text::Position::new(3, 1),
                ),
                selection_range: murder_text::Range::new(
                    murder_text::Position::new(0, 3),
                    murder_text::Position::new(0, 9),
                ),
                detail: None,
                raw: None,
            },
