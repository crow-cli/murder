...
impl SelectionRange {
    ...
    pub fn all_ranges(&self) -> Vec<murder_text::Range> {
...
impl SelectionRangeService {
    pub async fn provide_selection_ranges(
        client: &LspClient,
        uri: &str,
        positions: &[murder_text::Position],
    ...
    fn selection_range_serde() {
        let range = SelectionRange {
            range: murder_text::Range::new(
                murder_text::Position::new(5, 4),
                murder_text::Position::new(5, 10),
            ),
            parent: Some(Box::new(SelectionRange {
                range: murder_text::Range::new(
                    murder_text::Position::new(5, 0),
                    murder_text::Position::new(5, 30),
                ),
                parent: None,
            })),
        };
        ...
        let range = SelectionRange {
            ...
            parent: Some(Box::new(SelectionRange {
                ...
                parent: Some(Box::new(SelectionRange {
                    range: murder_text::Range::new(
                        murder_text::Position::ZERO,
                        murder_text::Position::new(100, 0),
                    ),
                    parent: None,
                })),
            })),
